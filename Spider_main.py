    ...
    def crawl(self, root_url):
        ...
        while self.urls.has_new_url(): # 启动一个循环,循环数值为new_urls集合的长度
            ...
            try:
                ...
                #     f.write('\n\n\n')
                log_dict['log_time'] = time.ctime()
                log_dict['log_status'] = 'failed'
                log_dict['url'] = f_url
                log_dict['failed_reason'] = str(e)
                self.outputer.log_connector(log_dict)
                ...
                #     f.write('\n\n\n')
                log_dict['log_time'] = time.ctime()
                log_dict['log_status'] = 'sucessed'
                log_dict['url'] = f_url
                log_dict['failed_reason'] = 'None'
                self.outputer.log_connector(log_dict)
...
if __name__ == "__main__":
    root_url = 'https://baike.baidu.com/item/qq' # 入口url
    t1 = time.time()
